    ...
    {       
        ...
        {   
            if(distributions[dependentVariable][variableList["independent-levels"][i]] == false)
            {
                ...
                d3.select("#svgCanvas").transition().duration(1000).attr("height", canvasHeight - 300).attr("viewBox", "0 -100 " + canvasWidth + " " + canvasHeight);
//                 d3.select("#canvas").transition().duration(1000).attr("style", "position: absolute; width: " + canvasWidth + "px; height: " + (canvasHeight-100) + "px; top: 100px; left: " + (width - canvasWidth) + "px;");    
            }
        }
