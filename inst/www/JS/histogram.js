                ...
                if(bins[labels[i]][j] != 0)
                {
                    ...
                    if(1)
                    {
                        canvas.append("line")
                                ...
                                .attr("y1", canvasHeight/2 + size/2 - (bins[labels[i]][j]/Array.max(binMaxs))*size/2)
                                .attr("x2", canvasWidth/2 - size/2 + j*xStep + (size/nBins)/2 + ((i+1)/labels.length)*size*0.25)    
                                .attr("y2", canvasHeight/2 + size/2 - (bins[labels[i]][j]/Array.max(binMaxs))*size/2)
                                .attr("display", "none")
                                .attr("stroke", "black")
                                .attr("id", ids[i] + j)
                        ...
                        canvas.append("text")
                                ...
                                .attr("y", canvasHeight/2 + size/2 - (bins[labels[i]][j]/Array.max(binMaxs))*size/2 + yAxisTickTextOffset)
                                .attr("fill", "black")
