                ...
                if(bins[labels[i]][j] != 0)
                {
                    if( ((bins[labels[i]][j]/Array.max(binMaxs))*size) < (0.1*size))
                    {
                        canvas.append("line")
                                ...
                                .attr("x2", canvasWidth/2 - size/2 + j*xStep + (size/nBins)/2 + ((bins[labels[i]][j]/Array.max(binMaxs))*size)/2 + (j/nBins)*size*0.5)    
                        ...
                        canvas.append("text")
                                .attr("x", canvasWidth/2 - size/2 + j*xStep + (size/nBins)/2 + ((bins[labels[i]][j]/Array.max(binMaxs))*size)/2 + (j/nBins)*size*0.5)                        
