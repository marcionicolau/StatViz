                ...
                if(bins[labels[i]][j] != 0)
                {
                    ...
                    if(1)
                    {
                        canvas.append("line")
                                ...
                                .attr("x2", canvasWidth/2 - size/2 + j*xStep + (size/nBins)/2 + ((bins[labels[i]][j]/Array.max(binMaxs))*size)/2 + ((i+1)/labels.length)*size*0.25)    
                        ...
                        canvas.append("text")
                                .attr("x", canvasWidth/2 - size/2 + j*xStep + (size/nBins)/2 + ((bins[labels[i]][j]/Array.max(binMaxs))*size)/2 + ((i+1)/labels.length)*size*0.25)                        
                                .attr("y", canvasHeight/2 + size/2 - (bins[labels[i]][j]/Array.max(binMaxs))*size + yAxisTickTextOffset)
                                .attr("fill", "black")
